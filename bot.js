...
if(message.content.startsWith(prefix + "slots")) {
  ...
  let slots2 = ['🍏', '🍇', '🍒', '🍍', '🍅', '🍆', '🍑', '🍓'];
  let slots3 = ['🍏', '🍇', '🍒', '🍍', '🍅', '🍆', '🍑', '🍓'];
  let slots1 = slots1[Math.floor(Math.random()*slot1.lenght)];
  let slots2 = slots2[Math.floor(Math.random()*slot2.lenght)];
  let slots3 = slots3[Math.floor(Math.random()*slot3.lenght)];
  let we;
